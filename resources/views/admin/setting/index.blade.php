              ...
              <div class="row">
                <div class="col-md-6">
                  <div class="form-group row">
                    ...
                    <div class="col-sm-9">
                      <input type="text" class="form-control" name="freelance_url" value="{{$setting->freelance_url}}" />
                    </div>
                  </div>
                </div>
                <div class="col-md-6">
              ...
              <div class="row">
                <div class="col-md-6">
                  <div class="form-group row">
                    ...
                    <div class="col-sm-9">
                      <input type="text" class="form-control" name="video_url" placeholder="Embded URL" value="{{$setting->video_url}}" />
                    </div>
                  </div>
                </div>
                <div class="col-md-6">
