...
<head>
    <meta charset="utf-8">
    <title>{{ config('app.name', 'Bivek Shrestha') }}</title>
...
<body data-spy="scroll" data-target=".navbar" data-offset="51">
    ...
    <nav class="navbar fixed-top navbar-expand-lg bg-light navbar-light py-3 py-lg-0 px-lg-5">
        {{-- <a href="index.html" class="navbar-brand ml-lg-3">
            <h1 class="m-0 display-5"><span class="text-primary">Bivek</span>Shrestha</h1>
        </a>
        <a
              href="#"
              
              class="navbar-brand ml-lg-3"
              ><img
                src="C:\laragon\www\Portfolio\resources\views\layouts\Screenshot 2024-07-18 134848.png"
                width="300px"
               
            /></a> --}}
            <a href="{{ url('/') }}" class="brandnav">
                <h1 class="logo-text">
